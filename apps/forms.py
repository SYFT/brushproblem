...
class UserForm(Form) :
	username = StringField('username', 
				validators = [
					DataRequired(message = ERROR_EMPTY(USERNAME)), 
...
class RegisterForm(UserForm) :
	...
	email = StringField('emailaddress', 
				validators = [
					DataRequired(message = ERROR_EMPTY(EMAIL)), 
...
class SuggestionForm(Form) :
	suggestion = TextAreaField('suggestion', 
				validators = [
					DataRequired(message = ERROR_EMPTY(SUGGEST)), 
